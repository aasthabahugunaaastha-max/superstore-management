...
public class StorekeeperDashboard {

    private final BorderPane root;
    private final SuperstoreSystem system;
    private final Storekeeper keeper;
    ...
    public StorekeeperDashboard(MainApp app, SuperstoreSystem system, Storekeeper keeper) {
        this.app = app;
        this.system = system;
        this.keeper = keeper;
        this.store = system.getStore(keeper.getFacilityId());
    ...
    private void build() {
        ...
        HBox topBar = new HBox(10,
                new Label("Storekeeper: " + keeper.getUsername()
    ...
    private void refreshData() {
        ...
        itemsObs.clear();
        for (Category c : store.getAllCategories()) {
